...
`nix run github:nix-community/nixos-anywhere -- --flake /home/user/.flake#lighthouse root@159.69.206.117` #had to use password based auth since on nix first reboot(into installer) it would no longer work, constantly ask for password
